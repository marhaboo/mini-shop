...
import useDebouns from "../../shared/utils/useDebouns";
import { useDispatch } from "react-redux";
import type { AppDispatch } from "../../app/store/store";
import { setSearch } from "../../entities/home/reducers/homeSlice";

const Header = () => {
  const [inputValude, setInputValue] = useState("");
  const debouncedValue = useDebouns(inputValude, 500);
